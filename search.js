...
const SITE_SEARCH_INDEX = [
  ...
  // ── IRA / השקעות ──
  {
    ...
    url: '/investment/ira/',
    desc: 'שאלון התאמה אינטראקטיבי, המלצת ברוקר וחישוב עלויות שנתיות. שירות צירוף 690 ₪.',
    kw: 'IRA ניהול אישי קופת גמל קרן השתלמות ברוקר גלובלנט פסגות IBI לאומי מזרחי 690'
  },
  {
