...
function buildWelcomeBar(name) {
  return '<div class="content-hero"><div class="container" style="display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:20px">' +
    '<div>' +
    ...
    '<a href="https://wa.me/972527700599?text=' + encodeURIComponent('איתן שלום, אני מעונין לקבוע שיחה בה נעבור על התיק שלי ונראה שהכל בסדר') + '" target="_blank" rel="noopener" ' +
    'style="display:inline-flex;align-items:center;gap:10px;background:#25D366;color:#fff;font-weight:800;font-size:17px;padding:14px 26px;border-radius:12px;text-decoration:none;box-shadow:0 3px 10px rgba(0,0,0,.18)">' +
    '<svg viewBox="0 0 32 32" width="20" height="20" fill="#fff" aria-hidden="true" style="flex-shrink:0"><path d="M16 .4C7.4.4.4 7.3.4 16c0 2.8.7 5.4 2 7.7L.3 31.6l8.1-2.1A15.5 15.5 0 0 0 16 31.6c8.6 0 15.6-7 15.6-15.6S24.6.4 16 .4zm0 28.2a13 13 0 0 1-6.6-1.8l-.5-.3-4.8 1.3 1.3-4.7-.3-.5A13 13 0 0 1 3 16C3 8.8 8.8 3 16 3s13 5.8 13 13-5.8 12.6-13 12.6zm7.1-9.5c-.4-.2-2.3-1.1-2.6-1.3-.4-.1-.6-.2-.9.2s-1 1.3-1.2 1.5c-.2.2-.4.3-.8.1-.4-.2-1.6-.6-3.1-1.9-1.1-1-1.9-2.3-2.1-2.7-.2-.4 0-.6.2-.8.2-.2.4-.4.6-.7.2-.2.2-.4.4-.6.1-.3 0-.5 0-.7l-1-2.5c-.3-.6-.5-.5-.7-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.1 1.1-1.1 2.7s1.2 3.2 1.3 3.4c.2.2 2.3 3.5 5.5 4.9 2 .8 2.7.9 3.7.7.6-.1 1.9-.8 2.2-1.5.3-.7.3-1.3.2-1.5-.1-.1-.4-.2-.8-.4z"/></svg>' +
    'קביעת שיחת רענון (בתשלום) עם איתן</a>' +
    '<div style="font-size:16px;font-weight:600;opacity:.95;margin-top:10px">מומלץ לעבור על התיק אחת ל-3 שנים בכדי לוודא שהכל אופטימלי</div>' +
    '</div>' +
    '</div></div>';
}
...
var IRA_COMPARISON_TABLE =
  ...
  '<tr><td class="highlight">מכפיל רווח (P/E)</td><td><span class="cross">כ-26</span></td><td>כ-23</td><td><span class="check">כ-20</span></td></tr>' +
  ...
  '</tbody></table></div>' +
  '<p style="font-size:12px;color:#999;margin:0 0 6px;">נתונים נכונים לספטמבר 2026. מקורות: Slickcharts, stockanalysis.com. מכפיל רווח (P/E): S&amp;P 500 לפי VOO (~26), ACWI (~23).</p>';
