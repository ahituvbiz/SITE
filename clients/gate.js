// gate.js — v15 | tag-based personalized content + insurance / donations / child-savings tabs + pension & savings calculators (#11)
...
var IRA_COMPARISON_TABLE =
  ...
  '</tbody></table></div>' +
  '<p style="font-size:12px;color:#999;margin:0 0 6px;">נתונים נכונים לאוגוסט 2026. מקורות: Slickcharts, stockanalysis.com. מכפיל רווח (P/E): S&amp;P 500 לפי VOO (~28), ACWI (~23).</p>';
...
var PENSION_CALC_HTML =
  '<div class="content-hero"><div class="container" style="display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:20px">' +
  '<div>' +
  '<div class="eyebrow">אזור לקוחות · כלי אישי</div>' +
  '<h1 style="margin-bottom:0">מחשבון פנסיה משפחתי</h1>' +
  '</div>' +
  '<div style="text-align:center;max-width:430px">' +
  '<a href="https://wa.me/972527700599?text=' + encodeURIComponent('שלום איתן, אשמח לקבוע שיחת רענון לתיק הפנסיוני') + '" target="_blank" rel="noopener" ' +
  ...
  '<div style="font-size:13px;opacity:.85;margin-top:8px">מומלץ לעבור על התיק אחת ל-3 שנים בכדי לוודא שהכל אופטימלי</div>' +
  '</div>' +
  '</div></div>' +
